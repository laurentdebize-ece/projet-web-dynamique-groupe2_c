...
$sql1 = "SELECT nom_competences FROM competences_transversales WHERE id_competence = :id_competences";
...
$sql4 = "DELETE FROM compet_trans_etudiant WHERE id_competence = :id_competences";
$requete4 = $bdd->prepare($sql4);
$requete4->execute(array(
    'id_competences' => $id_competences
));

$sql2 = "DELETE FROM compet_trans_matiere WHERE id_competence = :id_competences";
$requete = $bdd->prepare($sql2);
$requete->execute(array(
    'id_competences' => $id_competences
));

$sql3 = "DELETE FROM competences_transversales WHERE id_competence = :id_competences";
...
if ($requete->rowCount() > 0) {
    ...
    window.location.href = "page_Supp_CompTransv.php";
    </script>';
    exit();
}
